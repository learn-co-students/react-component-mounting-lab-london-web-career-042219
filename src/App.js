...
class App extends Component {
  ...
  //Your code here:
  // componentDidMount is reserved for taking initial actions within an app. Actions might include getting remoreAPI data, setting cursor focus, or creating an interval or timeout.

  //write a componentDidMount method that invokes the existing handleAddTime class method. The componentDidMount method is often a good place to include setInterval or setTimeout functions, allowing you to delay something from happening on a component or cause some repeating change. Perfect for our timer app.
  componentDidMount() {
    this.handleAddTimer();
  }
